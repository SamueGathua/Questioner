...
class TesstMeetupEndpoints(unittest.TestCase):
     ...
     def test_get(self):
         ...
         r = self.client.get("/api/v2/meetups/1", headers={"content-type": "application/json"})
         self.assertEqual(r.status_code, 200)
...
class TestConfirm(unittest.TestCase):
    ...
    def create_record(self):
        ...
        response = self.client.post('/api/v2/meetups/1/confirms',
                            data=json.dumps(new_rec),
                            headers={"content-type": "application/json"})
        return response
    ...
    def test_confirm_get(self):
         self.create_record()
         r = self.client.get("/api/v2/meetups/1/confirms", headers={"content-type": "application/json"})
         self.assertEqual(r.status_code, 200)
